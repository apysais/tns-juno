<?php if(isset($bracket['bracket_4'])){ ?>
<h5>Bracket 4 Details</h5>
<p>Total Billing Cycles : <?php echo $bracket['bracket_4']['total_billing_cycle'];?></p>
<p>Total Value : <?php echo tns_money_format($bracket['bracket_4']['total_value']);?></p>
<table class="table table-bracket table-bordered">
  ...
  <tbody>
    <?php if(isset($bracket['bracket_4']['data'])){ ?>
      <?php foreach($bracket['bracket_4']['data'] as $k => $v) { ?>
        <tr>
