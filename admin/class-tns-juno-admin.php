...
class Tns_Juno_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Tns_Juno_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Tns_Juno_Loader will then create the relationship
		...
		wp_enqueue_style( $this->plugin_name . '-datatable', tns_get_plugin_dir_url() . 'assets/datatables/datatables.min.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name . '-datatables-js', tns_get_plugin_dir_url() . 'assets/datatables/datatables.min.js', array( 'jquery' ), $this->version, false );
